...
public class AlarmAlertFullScreen extends Activity {
    ...
    private void setTitle() {
        ...
        title.setText(label);
        String tempTest;
        tempTest = mAlarm.mode+"";
        Log.i("mytest",tempTest);
        Log.i("mytest","fuck");
    }
    ...
    private void updateLayout() {
        ...
        final int mode = mAlarm.mode;
        findViewById(R.id.dismiss).setOnClickListener(
                new Button.OnClickListener() {
                    public void onClick(View v) {
                    	switch(mode){
                    	case 1:break;
                    	case 2:Intent intentshake = new Intent();
                    	       intentshake.setClass(AlarmAlertFullScreen.this, AlarmAlartShake.class);
                    	       startActivity(intentshake);
                    	       break;
                    	case 3:Intent intentlight = new Intent();
                    		   intentlight.setClass(AlarmAlertFullScreen.this, AlarmAlertLight.class);
                    		   startActivity(intentlight);
                    		   break;
                    	case 4:Intent intentGradienter = new Intent();
                    			intentGradienter.setClass(AlarmAlertFullScreen.this, Gradienter.class);
                    			startActivity(intentGradienter);
                    			break;
                    	}
                        dismiss(false);
                    }
    ...
    private void snooze() {
        ...
        Log.v("aafsTest", " AlarmAlertFullScreen"+displayTime);
    ...
    protected void onNewIntent(Intent intent) {
        ...
        Log.v("aafsTest", "AlarmAlert.OnNewIntent()");
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.v("aafsTest", "AlarmAlert.onDestroy()");
