...
public final class Alarm implements Parcelable {
    ...
    public static class Columns implements BaseColumns {
        /**
         * The content:// 涓鸿繖涓〃瀹氫箟涓�涓叡浜殑Url
         */
        ...
        static final String[] ALARM_QUERY_COLUMNS = {
            ...
            ENABLED, VIBRATE, MESSAGE, ALERT, MODE};
        ...
        public static final int ALARM_MODE_INDEX = 9;
    }
    //////////////////////////////
    // End 姣忎竴鍒楀畾涔夌粨鏉�
    //////////////////////////////
    ...
    public Alarm(Cursor c) {
        ...
        mode = c.getInt(Columns.ALARM_MODE_INDEX);
        String alertString = c.getString(Columns.ALARM_ALERT_INDEX);
        if (Alarms.ALARM_ALERT_SILENT.equals(alertString)) {
            if (true) {
                Log.v("智能终端", "Alarm is marked as silent");
            }
            silent = true;
        } else {
